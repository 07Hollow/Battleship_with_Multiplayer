from import_and_color_size_setting import block_size, upper_margin, screen, font, WHITE, BLACK, GREEN_BLUE, pygame
...
class Button:
    ...
    def __init__(self, x_offset, button_title, message_to_show):
        ...
        self.__button_width = self.__title_width + block_size - 10
        self.__button_height = self.__title_height + block_size - 10
